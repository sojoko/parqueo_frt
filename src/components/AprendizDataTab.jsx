  ...
  const handleLoad = useCallback(async () => {
    try {
      ...
      const response = await fetch(
        `${API_URL}/aprendiz-statu/${documentByParams}`,
        {
          method: "get",
          headers: {
              ...
              <tbody>
                <tr>
                  <td className="border-y border-purple-300 p-4">                   
                    ...
                    <Avatar src={aprendizData.photo} alt={"foto"} size="sm" />
                  ...
                  <td className="border-y border-purple-300 p-4">
                    <Chip
                      ...
                      size="sm"
                      value={
                        aprendizData.state_id === 1
                          ? "Pendiente"
                          : aprendizData.state_id === 2
                          ? "Aceptado"
                          : "Rechazado"
                      }
                      color={
                  ...
                  <td className="border-y border-purple-300 p-4">
                    <button
                      onClick={() => handleOpenModalImg(aprendizData.photo)}
                      type="button"
                    >
                  ...
                  <td className="border-y border-purple-300 p-4">
                    <button
                      onClick={() =>
                        handleOpenModalImg(aprendizData.vehicle_0.foto)
                      }
                    >
                  ...
                  <td className="border-y border-purple-300 p-4">
                    <button
                      onClick={() =>
                        handleOpenModalImg(
                          aprendizData.vehicle_0.tarjeta_propiedad
                        )
                      }
                      type="button"
                    >
